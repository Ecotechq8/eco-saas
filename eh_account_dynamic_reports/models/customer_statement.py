...
class EhCustomerStatementHandler(models.AbstractModel):
    ...
    def _build_columns(self):
        return [
            {'expression_label': 'description', 'name': "Description",
             'figure_type': 'string'},
            {'expression_label': 'date', 'name': "Date",
             'figure_type': 'string'},
            {'expression_label': 'reference', 'name': "Reference",
             'figure_type': 'string'},
            {'expression_label': 'due_date', 'name': "Due",
             'figure_type': 'string'},
            {'expression_label': 'charge', 'name': "Charge",
             'figure_type': 'monetary'},
            {'expression_label': 'payment', 'name': "Payment",
             'figure_type': 'monetary'},
    ...
    def _build_lines(self, opening, rows, date_to):
        ...
        lines.append({
            'id': 'amount_due',
            'name': "Amount %s as of %s" % (
                self.DIRECTION_LABEL, self._iso_date(date_to),
            ),
            'level': 0,
            'columns': [
                {'expression_label': 'date', 'value': ''},
...
class EhVendorStatementHandler(models.AbstractModel):
    ...
    REPORT_NAME = "Vendor Statement"
    ACCOUNT_TYPE = 'liability_payable'
    SIGN = -1
    DIRECTION_LABEL = "we owe vendor"
