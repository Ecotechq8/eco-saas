...
class EhAgedBaseHandler(models.AbstractModel):
    ...
    def _build_columns(self):
        return [
            {'expression_label': 'partner', 'name': "Partner",
             'figure_type': 'string'},
            {'expression_label': 'not_due', 'name': "Not Due",
             'figure_type': 'monetary'},
            {'expression_label': 'bucket_30', 'name': "0 to 30 Days",
             'figure_type': 'monetary'},
            {'expression_label': 'bucket_60', 'name': "31 to 60 Days",
             'figure_type': 'monetary'},
            {'expression_label': 'bucket_90', 'name': "61 to 90 Days",
             'figure_type': 'monetary'},
            {'expression_label': 'bucket_older', 'name': "91 Plus Days",
             'figure_type': 'monetary'},
            {'expression_label': 'total', 'name': "Total",
             'figure_type': 'monetary'},
        ]
