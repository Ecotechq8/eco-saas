...
class StockPicking(models.Model):
    ...
    report_template_id1 = fields.Many2one('ir.actions.report' , string="Picking Template", compute='_default_report_template1', help="Please select Template report for Picking", domain=[('model', '=', 'stock.picking')])
    report_template_id = fields.Many2one('ir.actions.report' , string="Picking Template", help="Please select Template report for Picking", domain=[('model', '=', 'stock.picking')])
