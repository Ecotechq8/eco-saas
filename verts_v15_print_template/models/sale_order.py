...
class SaleOrder(models.Model):
    ...
    report_template_id1 = fields.Many2one('ir.actions.report' , string="Sale Order Template", compute='_default_report_template1', help="Please select Template report for Sale Order", domain=[('model', '=', 'sale.order')])
    report_template_id = fields.Many2one('ir.actions.report' , string="Sale Order Template", help="Please select Template report for Sale Order", domain=[('model', '=', 'sale.order')])
