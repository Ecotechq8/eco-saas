...
class AttendanceWizard(models.TransientModel):
    ...
    def sync_attendance(self):
        ...
        synch_ignore_constraints = self.env.context.get('synch_ignore_constraints', True)
                    ...
                    if hr_attendance_id:
                        try:
                            ...
                            msg += _("'Check Out' time cannot be earlier than 'Check In' time. Debug information:<br />"
                                     ...
                                     "* Type: %s<br />"
                                     "* Attendance Check Time: %s<br />") % (employee_id.name, att.type,
