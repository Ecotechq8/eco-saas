...
class AttendanceDevice(models.Model):
    ...
    name = fields.Char(string="Name", required=True, help='The name of the attendance device',
                       track_visibility='onchange', translate=True, copy=True, default='/')
    ...
    ip = fields.Char(string="IP / Domain Name", required=True, track_visibility='onchange', copy=False,
                     help='The accessible IP or Domain Name of the device to get device\'s attendance data',
                     default='0.0.0.0')
    port = fields.Integer(string="Port", required=True, default=4370, track_visibility='onchange')
    ...
    auto_clear_attendance_schedule = fields.Selection([
        ...
        default='on_download_complete', track_visibility='onchange',
    ...
    auto_clear_attendance_hour = fields.Float(string='Auto Clear At', track_visibility='onchange', required=True,
                                              default=0.0,
    ...
    auto_clear_attendance_error_notif = fields.Boolean(string='Auto Clear Attendance Notif.', default=True,
                                                       oldname='auto_clear_atttendance_error_notif',
                                                       track_visibility='onchange',
    ...
    active = fields.Boolean(string='Active', default=True, track_visibility='onchange', readonly=True,
    ...
    def _set_zk(self):
        ...
        self.zk['connect'] = self.zk_cache[cached_key]
    ...
    def connect(self):
        ...
        try:
            self._set_zk()
            return self.zk['connect'].connect()
    ...
    def disconnect(self):
        try:
            return self.zk['connect'].disconnect()
        except Exception as e:
            _logger.error(e)
    ...
    def disableDevice(self):
        ...
        """
        try:
            return self.zk['connect'].disable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def enableDevice(self):
        ...
        """
        try:
            return self.zk['connect'].enable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def getFirmwareVersion(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_firmware_version()
        except Exception as e:
            _logger.error(e)
    ...
    def getSerialNumber(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_serialnumber()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getOEMVendor(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_oem_vendor()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getFingerprintAlgorithm(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_fp_version()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getPlatform(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_platform()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def getDeviceName(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_device_name()
        except Exception as e:
            _logger.error(e)
    ...
    def getWorkCode(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_workcode()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
    ...
    def restartDevice(self):
        ...
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].restart()
        except Exception as e:
            _logger.error(e)
            raise ValidationError(
                _('Could not get the serial number of the device %s. Here is the debugging information:\n%s')
    ...
    def setUser(self, uid=None, name='', privilege=0, password='', group_id='', user_id='', card=0):
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].set_user(uid, name, privilege, password, group_id, user_id, card)
        except Exception as e:
            _logger.info(e)
    ...
    def delUser(self, uid, user_id):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].delete_user(uid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def action_clear_data(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].clear_data()
        except Exception as e:
            _logger.error(e)
    ...
    def getUser(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].get_users()
        except Exception as e:
            _logger.error(str(e))
    ...
    def upload_finger_templates(self, uid, name, privilege, password, group_id, user_id, fingers):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].save_user_template(user, fingers)
        except Exception as e:
            _logger.error(e)
    ...
    def delFingerTemplate(self, uid, fid, user_id):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].delete_user_template(uid, fid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def getFingerTemplate(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].get_templates()
        except Exception as e:
            _logger.error(str(e))
    ...
    def get_next_uid(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].get_next_uid()
        except Exception as e:
            _logger.error(str(e))
    ...
    def getMachineTime(self):
        try:
            self.connect()
            self.enableDevice()
            return self.zk['connect'].get_time()
        except Exception as e:
            _logger.error(str(e))
    ...
    def getAttendance(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].get_attendance()
    ...
    def clearAttendance(self):
        ...
        try:
            ...
            self.enableDevice()
            self.disableDevice()
            return self.zk['connect'].clear_attendance()
        except Exception:
            raise ValidationError(_('Could not get attendance data from the device %s') % (self.display_name,))
        finally:
            self.enableDevice()
            ...
            for device_user in device_users:
                ...
                if uid not in existing_user_ids:
                    ...
                    if existing:
                        ...
                        if existing.device_user_id != vals['device_user_id']:
                            update_data['device_user_id'] = vals['device_user_id']
    ...
    def _download_users_by_user_id(self):
        ...
        for r in self:
            ...
            existing_user_ids = []
            device_user_ids = DeviceUser.with_context(active_test=False).search([('device_id', '=', r.id)])
            for user in device_user_ids.filtered(lambda user: user.device_user_id in user_ids):
                existing_user_ids.append(str(user.device_user_id))
    ...
    def get_one_by_one_status(self, user_id, timestamp):
        DeviceUserAttendance = self.env['user.attendance']
        prev_att = DeviceUserAttendance.search([('employee_id', '=', user_id.employee_id.id),
                                                ('timestamp', '<', timestamp)], limit=1, order='timestamp DESC')
        if not prev_att:
            return 0

        resource_line = user_id.employee_id.resource_calendar_id.get_resource_line(timestamp)
        if resource_line:
            prev_att_tz_timestamp = self.convert_utc_time_to_tz(prev_att.timestamp, self.tz)
            check_prev_att = resource_line.is_in_shift(prev_att_tz_timestamp)
            if check_prev_att:
                return 1 if prev_att.status == 0 else 0
        return 0

    def get_filo_status(self, user_id, timestamp):
        DeviceUserAttendance = self.env['user.attendance']
        prev_att = DeviceUserAttendance.search([('employee_id', '=', user_id.employee_id.id),
                                                ('timestamp', '<', timestamp)], limit=1, order='timestamp DESC')
        if not prev_att:
    ...
    def get_attendance_vals(self, user_id, attendance, attendance_states, utc_timestamp):
        if self.attendance_methode == 'filo':
            status = self.get_filo_status(user_id, attendance.timestamp)
            return {
                'device_id': self.id,
                'user_id': user_id.id,
                'timestamp': utc_timestamp,
                'status': status,
                'attendance_state_id': attendance_states[status]
            }
        elif self.attendance_methode == 'one_by_one':
            status = self.get_one_by_one_status(user_id, attendance.timestamp)
            return {
                'device_id': self.id,
                'user_id': user_id.id,
                'timestamp': utc_timestamp,
    ...
    def get_attendance_action(self):
        return {
            'type': 'ir.actions.act_window',
            'name': 'Get Attendance Wizard',
            'res_model': 'get.attendance',
            'view_mode': 'form',
            'view_type': 'form',
            'view_id': self.env.ref('to_attendance_device.get_attendance_wizard', False).id,
            'target': 'new',
            'context': {'default_device_id': self.id}
        }

    def filter_attendance_data(self, attendance, start_date, end_date):
        utc_timestamp = self.convert_time_to_utc(attendance.timestamp, self.tz)
        utc_start_date = self.convert_time_to_utc(start_date, self.tz)
        utc_end_date = self.convert_time_to_utc(end_date, self.tz)
        return utc_timestamp >= utc_start_date and utc_timestamp <= utc_end_date

    def action_attendance_download(self, start_date=None, end_date=None):
        DeviceUserAttendance = self.env['user.attendance']
        ...
        for r in self:
            ...
            # attendance_data = r.get_attendance_data()
            if start_date and end_date:
                attendance_data = list(
                    filter(lambda att: r.filter_attendance_data(att, start_date, end_date), attendance_data))
            for attendance in attendance_data:

                user_id = AttendanceUser.search([('device_user_id', '=', attendance.user_id), ('device_id', '=', r.id)],
                                                limit=1)
                if user_id:
                    print(attendance.punch)
                    if attendance.punch in [0, 1, 4, 5]:
                        utc_timestamp = r.convert_time_to_utc(attendance.timestamp, r.tz)
                        utc_timestamp = utc_timestamp.strftime("%Y-%m-%d %H:%M:%S")
                        utc_timestamp = datetime.strptime(utc_timestamp, "%Y-%m-%d %H:%M:%S")
                        duplicate_attend = DeviceUserAttendance.search(
                            [('device_id', '=', r.id), ('user_id', '=', user_id.id),
                        ...
                        if not duplicate_attend:
                            ...
                            # vals = r.get_attendance_vals(user_id, attendance, attendance_states, utc_timestamp)
    ...
    def is_attendance_clear_safe(self):
        ...
        for att in attendances:
            ...
            user = User.with_context(active_test=False).search(
                [('device_user_id', '=', att.user_id), ('device_id', '=', self.id)], limit=1)
    ...
    def action_device_information(self):
        ...
        for r in self:
            try:
                ...
                r.connect()
                r.firmware_version = r.zk['connect'].get_firmware_version()
    ...
    def get_dict_attendance_data(self):
        return [
            {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 8, 10, 30, 82829),
                'status': 1,
                'punch': 0,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 8, 20, 30, 82829),
                'status': 1,
                'punch': 1,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 8, 30, 30, 82829),
                'status': 1,
                'punch': 0,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 12, 10, 30, 82829),
                'status': 1,
                'punch': 1,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 12, 20, 30, 82829),
                'status': 1,
                'punch': 0,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 12, 30, 30, 82829),
                'status': 1,
                'punch': 1,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 13, 10, 30, 82829),
                'status': 1,
                'punch': 0,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 13, 20, 30, 82829),
                'status': 1,
                'punch': 1,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 13, 30, 30, 82829),
                'status': 1,
                'punch': 0,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 17, 10, 30, 82829),
                'status': 1,
                'punch': 1,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 17, 20, 30, 82829),
                'status': 1,
                'punch': 0,
            }, {
                'uid': 1,
                'user_id': '1',
                'timestamp': datetime(2021, 4, 12, 17, 30, 30, 82829),
                'status': 1,
                'punch': 1,
            },
        ]
    ...
    def get_attendance_data(self):
        attendance_data = self.get_dict_attendance_data()
        attendances = []
        for att in attendance_data:
            attendance = Attendance(att['user_id'], att['timestamp'], att['status'], att['punch'], att['uid'])
