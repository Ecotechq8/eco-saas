...
class SubscriptionPlan(models.Model):
    ...
    # v18 SQL constraint style (_sql_constraints). (v19 uses models.Constraint.)
    _sql_constraints = [
        ('billing_period_positive', 'CHECK(billing_period_value > 0)',
         'The billing period must be strictly positive.'),
        ('auto_close_limit_positive', 'CHECK(auto_close_limit >= 0)',
