...
class ResUsers(models.Model):
    ...
    #     print('onchange_user_profileonchange_user_profile')
    ...
    def create(self, vals):
        ...
        if record.is_user_profile:
            record.active = False
            # Use ORM instead of raw SQL (Odoo 18 migration)
            ...
            for key, value in vals.items():
                if key.startswith('in_group_'):
                    ...
                    if group_id_match:
                        ...
                        # Determine if the group is added or removed based on the boolean value
